...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-slate-950 py-16 text-slate-300">
      ...
      <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-4 border-t border-white/10 px-6 pt-8 text-sm text-slate-400 lg:flex-row lg:items-center lg:justify-between lg:px-8">
